...
The Telegram hook (`telegram_notify.sh`) automatically sends notifications when Claude Code sessions stop or subagents
complete tasks. It provides detailed summaries including tool usage, files modified, and operation counts.
...
5 Edit 3 Read 2 Bash 2 Write 1 TodoWrite 1 Grep 1 Glob
...
12 Edit 6 Read 3 Write 2 Bash 1 TodoWrite
