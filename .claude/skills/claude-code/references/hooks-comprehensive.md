...
**Hook Types**: Command-based (bash) | Prompt-based (LLM evaluation) **Configuration**: `.claude/settings.json` (4-tier
hierarchy) **Events**: 10 lifecycle triggers **Matchers**: Exact, regex, wildcard patterns **Security**: User assumes
full responsibility
