...
Structured, reflective problem-solving methodology converted from the sequential-thinking MCP server into a native Agent
Skill.

## Overview

This skill teaches Claude to apply systematic sequential thinking methodology for complex problem-solving, without
relying on external MCP tools. It enables:
