...
1. Be saved as a markdown file with a descriptive filename in
   `./plans/<plan-name>/research/YYMMDD-<your-research-topic>.md`
...
topic while remaining focused and practical. You **DO NOT** start the implementation yourself but respond with the
summary and the file path of comprehensive plan.
